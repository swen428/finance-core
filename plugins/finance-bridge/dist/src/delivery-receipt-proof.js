...
export const FINANCE_DELIVERY_RECEIPT_PROOF_VERSION = "finance_delivery_receipt_proof_v1";
const KEY_BYTES = 32;
...
function proofMaterial(workspacePath, material) {
    return Buffer.concat([
...
export function financeDeliveryReceiptProofSha256(signingKey, workspacePath, material) {
...
async function loadSigningKey(config) {
    ...
    if (!runtime.isDirectory() || (runtime.mode & 511n) !== 448n ||
    ...
    if (!before.isFile() || before.isSymbolicLink() || (before.mode & 511n) !== 384n ||
...
export const financeDeliveryReceiptProofProvider = {
