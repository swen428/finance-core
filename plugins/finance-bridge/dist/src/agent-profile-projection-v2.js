...
export function canonicalProjectionSha256V2(projection) {
 ...
 */
export function projectFinanceAgentConfigV2(sourceValue) {
    ...
    if (agent.id !== "finance")
        throw new Error("The only Agent must be finance.");
    ...
    if (typeof model.primary !== "string")
        throw new Error("finance model.primary is invalid.");
    ...
    return {
        ...
        plugin_binding_policy_sha256: string(policies.pluginBindingPolicySha256, HASH, "plugin binding policy hash"),
        projection_policy_version: string(policies.projectionPolicyVersion, VERSION, "projection policy version"),
        projection_policy_sha256: string(policies.projectionPolicySha256, HASH, "projection policy hash"),
