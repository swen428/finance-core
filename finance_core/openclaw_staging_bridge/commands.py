...
from finance_core.intake.receipt_ocr_proposal import (
    ...
    get_receipt_ocr_extraction_status_for_proposal,
...
def _fetch_proposal_by_public_id(
    ...
    if proposal is None:
        raise errors.bridge_error(
            ...
            "Proposal public ID was not found in the staging database.",
            errors.EXIT_VALIDATION_REFUSED,
        )
    return proposal
...
def handle_get_review(request: BridgeRequest, deadline: Deadline) -> HandlerResult:
    ...
    try:
        ...
        if ai_origin and ambiguity_indicators:
        ...
        return {
            ...
            "callback_tokens": callback_tokens_payload,
